...
class Benchmark:
    ...
    def add_function(self, fun: Callable[[], Any] | str) -> None:
        ...
        if isinstance(fun, str):
            f: Callable[[], Any] = eval("lambda: " + fun)
            f.__name__ = fun
            f.__doc__ = fun
            fun = f
    ...
    def report_html(
        ...
        normalized = (
            None if normalize_with is None else self.__normalized_times(normalize_with)
        )
