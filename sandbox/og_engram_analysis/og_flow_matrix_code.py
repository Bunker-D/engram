...
"""Flow matrix for the pairs of keys (i.e., penalty-based scores)\n
Matched to: `keys24`×`keys24`"""
...
def create_32x32_flow_matrix(not_home_row, side_top, side_above_3away, side_above_2away, side_above_1away,
    ...
    # 8.  Promote little-to-index-finger roll-ins over index-to-little-finger outward rolls.
